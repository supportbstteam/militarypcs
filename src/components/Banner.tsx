...
const Banner: React.FC<BannerProps> = ({ title, subtitle }) => {
  return (
<section
  className="relative bg-cover   bg-position-[20%_80%] md:bg-position-[20%_80%] md:bg-center mx-auto flex items-center rounded-3xl "
            ...
            <div className="md:w-[55%]  ">
                ...
                <p className="text-lg md:text-xl mb-8 md:w-8/12 text-white sm:leading-10">
                 ...
                 <div className="flex flex-col lg:flex-row gap-6">
                    <Button variant="outline" href="/">Find a Service Provider</Button>
                    <Button variant="outline" href="/">Join as a Professional</Button>
                 </div>
